                 ...
                 <div
                   ...
                   >
                    <div className='flex items-center gap-2'>
                       ...
                       toast.error(`${item.title} is removed`)} className='text-xl text-gray-600 hover:text-red-600
                   ...
                   {/* <div className='display flex gap-2'>
                     <button className='border 5px  border-gray-400 p-1  hover:border-red-600'>-</button>
                     <p>Quantity{item.Quantity}</p>
                     <button className='border 5px  border-gray-400 p-1  hover:border-red-600'>+</button>
                   </div> */}
                   <div className='display flex gap-2 align items-center border 1px border-gray-400 px-2'>
